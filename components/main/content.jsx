...
import Styles from "../sub/Roadmap.module.css";
...
<br/>
      <div className={Styles["dev-roadmap-left"]} >
        ...
        <br/><li> 1-Database intro            </li>
          ...
          <h4 className={Styles["dev-roadmap-mint-title"]}> 3-
            PHP OOP  🥳</h4>
          <br/><li> Laravel            </li>
          <br/><li> Laravel mvc structure            </li>
          <br/><li> outing            </li>
          <br/><li> models             </li>
          <br/><li> uery builder            </li>
          <br/><li> Query builder             </li>
          <br/><li> CRUD Operations            </li>
          <br/><li> Laravel Validation            </li>
          <br/><li> Session            </li>
          <br/><li> Assets            </li>
          <br/><li> Seeders – factories – tinker             </li>
          <br/><li> Authantication            </li>
          <br/><li> Authorization            </li>
          <br/><li> Middleware              </li>
          <br/><li> API Resources             </li>
          <br/><li> API Authantication             </li>
          <br/><li> Email Verification            </li>
          <br/><li> Pusher            </li>
          <br/><li> Agile            </li>
          <br/><li> wagge </li> <br />
         <h4 className={Styles["j"]}>End Of Content Of PHP  👋</h4>
